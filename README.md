...
# What it can do
- Interpret bytecode
- Rudimentarily analyze "hot" code paths and JIT compile them

Mirage is ~1100 LoC and does most of the bytecode work already. We're probably never going to get as fast/efficient as LLVM which has millions of hours of manpower and research applied to it with millions of LoC.
